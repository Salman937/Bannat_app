                            ...
                            @foreach($subcategories as $cat)
                              <tr class="gradeX">
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('subcategory.destroy', [$cat->id]) }}" onclick=" return confirm('Are you sure you want to delete this record');" class="btn btn-danger btn-xs" title="Delete Colour"><i class="fa fa-trash"> </i> </a>
                                </td>
                              </tr>
                            @endforeach
                        </tbody>
